module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@naraa'
      ...
      if (!('owners' in setting)) setting.owners = ['6288295249563', '6288220924312', '16103406077']
      ...
      global.db.setting = {
         ...
         prefix: ['.', '#', '!', '/'],
         onlyprefix: '+',
         owners: ['6288295249563', '6288220924312', '16103406077'],
         mods: [],
